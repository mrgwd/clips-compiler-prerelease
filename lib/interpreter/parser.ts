...
export type NodeType = "Program" | "Expression" | "Literal" | "Variable" | "Symbol" | "Identifier"
...
export function parse(tokens: Token[]): Node {
  ...
  function parseExpression(): Node {
    ...
    if (token.type === "LPAREN") {
      ...
      if (operatorToken.type === "IDENTIFIER" && operatorToken.value === "loop-for-count") {
      ...
      // Normal case - operator followed by arguments
      else if (operatorToken.type === "IDENTIFIER" || operatorToken.type === "SYMBOL") {
        expression.children = [parseAtom()]
        ...
        throw new Error(`Expected identifier or symbol, got ${operatorToken.type}`)
      }
